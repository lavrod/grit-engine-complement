...
gge_gfx_particle_ambient(vec(1, 1, 1))

cam_pos = vec(0, 0, 0)
cam_look = vec(0, 100, 0)
cam_quat = quat(vec(0, 1, 0), cam_look - cam_pos)

b1 = gge_gfx_tracer_body_make()
...
for i = 0, 5000, 10 do
    ...
    gge_gfx_render(0.1, cam_pos, cam_quat)
    gge_gfx_tracer_body_pump(0.1)
end

gge_gfx_screenshot('output-tracer1.png')


b2 = gge_gfx_tracer_body_make()
b2.length = 10
b2.size = 0.2
b2.alpha = 0.75
...
gge_gfx_screenshot('output-tracer2.png')
