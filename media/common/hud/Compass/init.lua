...
hud_class `.` {
    ...
    init = function (self)
        ...
        self.N = gge_hud_text_add(cardinalLettersFont)
        self.N.text = "N"
        ...
        self.S = gge_hud_text_add(cardinalLettersFont)
        self.S.text = "S"
        ...
        self.W = gge_hud_text_add(cardinalLettersFont)
        self.W.text = "W"
        ...
        self.E = gge_hud_text_add(cardinalLettersFont)
        self.E.text = "E"
